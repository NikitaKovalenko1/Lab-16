...
{
    cout << "—ортировка методом естественного сли€ни€" << endl;
    int p = 0;
    int i = 0;
    int j;
    int** a = new int* [r1];
...
{
    cout << "—ортировка методом сбалансированного сли€ни€" << endl;
...
vector<int> PolyphaseMergeSort(vector<int> vec)
{
    ...
    cout << "–азделение на равные серии" << endl;
    PrintSeries(series);
    ...
    cout << "–азделение серий на файлы F1 и F2 (" << size1 << " " << size2 << ")" << endl;
    PrintFiles(F1, F2, F3);

    // sort elements inside series
    cout << "—ортировка элементов внутри файлов" << endl;
